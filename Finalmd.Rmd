...
```
The correlation coefficients between Sales and Population at the city level and county level are the highest at 0.6674 and 0.6533 respectively. Zipcodes still shows a correlation, but it is a weak one at 0.5013
...
We can see as population increases so does your total number of sales which makes sense.
